...
export const USER_FACING_MODELS: AIModelConfig[] = [
  {
    ...
    modelInfo: 'Llama 3.1 8B',
    description: 'Quick answers, everyday chat, and rapid drafting',
    badge: '⚡ Fast',
  ...
  },
  {
    ...
    modelInfo: 'Llama 3.3 70B',
    description: 'Everyday intelligence, multi-PDF document analysis & vision',
    badge: '✦ Default & Vision',
...
export const AI_MODELS: AIModelConfig[] = [
  ...
  },
  {
    ...
    description: 'Next-generation multimodal reasoning model with real-time speed and vision',
    badge: 'Gemini 2.0',
  ...
  },
  {
    ...
    description: 'Massive context window intelligence with multimodal deep reasoning',
    badge: 'Long Context',
    badgeColor: 'bg-indigo-950/80 text-indigo-300 border-indigo-700/50',
    available: true,
    supportsVision: true,
  ...
  },
  {
    ...
    description: 'Open-weights reasoning model with mathematical and algorithmic synthesis',
...
export const DEFAULT_VISION_MODEL_ID = 'google-gemini-2-0-flash';
